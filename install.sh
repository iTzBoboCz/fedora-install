...
LAPTOP=false
NVIDIA=false
HELP_MSG="Optional arguments are:\n  --help | -h: Help page\n  --nonfree: Installs RPMFusion Non-Free repos\n  --steam: Installs steam (flatpak version to avoid fedora lib misaligment issues for games)\n  --darktheme: Default light, if you pass this argument, this script will change your system's look to dark.\n  --laptop: Enables powersaving features --nvidia: Installs proprietary drivers. If --laptop is also passed, it installs system76-power."
...
printf "\nSettings:\n  Theme: ${THEME}\n  RPMFusion Nonfree repo: ${NONFREE}\n  Install steam: ${STEAMFLAT}\n  Laptop: ${LAPTOP}\n  NVIDIA: ${NVIDIA}\n"
printf "\nYou may need to enter your password multiple times! Proceed? [Y/N]: " && read CONTINUE
